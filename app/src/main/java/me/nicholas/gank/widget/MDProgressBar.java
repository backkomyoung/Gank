package me.nicholas.gank.widget;
...
public class MDProgressBar extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MDProgressBar_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MDProgressBar_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MDProgressBar_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MDProgressBar_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MDProgressBar_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MDProgressBar_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MDProgressBar_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.MDProgressBar_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MDProgressBar_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.MDProgressBar_matProg_progressIndeterminate, false)) {
            spin();
        }
